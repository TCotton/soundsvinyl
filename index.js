 ...
 */
const loadingFunction = () => import('./src/front-non-library/index.js');
 ...
 * One useful convention might be to prefix
 * the url with the name of the app that is active,
 * to keep your top-level routing simple.
 */
const activityFunction = location => location.pathname.startsWith('/non-library');
